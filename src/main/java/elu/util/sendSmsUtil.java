...
public class sendSmsUtil {
	...
	public static void sendSms(String telNum,String msg){
		try {
			...
			requestSms.setParamString("{\"code\":\""+msg+"\"}");//短信模板中的变量；数字需要转换为字符串；个人用户每个变量长度必须小于15个字符。"
//			requestSms.setParamString("{}");
			requestSms.setRecNum(telNum);//接收号码
